...
FD_generic_frame *create_form_generic_frame(void)
{
  ...
  fdui->generic_frame = fl_bgn_form(FL_NO_BOX, 825, 385);
  obj = fl_add_box(FL_FLAT_BOX,0,0,825,385,"");
  ...
  fdui->daemon = obj = fl_add_input(FL_MULTILINE_INPUT,410,80,400,210,"Daemon");
  ...
  fdui->generic_inherits = obj = fl_add_input(FL_NORMAL_INPUT,410,25,270,30,"Inherits:");
    fl_set_object_color(obj,FL_WHITE,FL_WHITE);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
  ...
  fdui->generic_accept_button = obj = fl_add_button(FL_NORMAL_BUTTON,690,300,120,30,"Accept");
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,generic_accept_button_cb,0);
  fdui->instances_menu = obj = fl_add_menu(FL_PULLDOWN_MENU,690,25,120,30,"Instances");
    fl_set_object_boxtype(obj,FL_UP_BOX);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,instances_menu_cb,0);
  fdui->facet_menu = obj = fl_add_menu(FL_PULLDOWN_MENU,280,300,120,30,"New Facet");
    fl_set_object_boxtype(obj,FL_UP_BOX);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
  ...
  fdui->quit_button = obj = fl_add_button(FL_NORMAL_BUTTON,690,340,120,30,"Quit");
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,quit_button_cb,0);
  fdui->save_button = obj = fl_add_button(FL_NORMAL_BUTTON,490,340,120,30,"Save");
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,save_button_cb,0);
  fdui->open_button = obj = fl_add_button(FL_NORMAL_BUTTON,490,300,120,30,"Open");
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
